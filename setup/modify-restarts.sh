...
python3 python apply_bathy_mom_restarts.py --template_dir $template_dir --old_dir $old_dir --output_dir $output_dir --template_prefix access-om3.mom6.r.1900-01-01-00000 --old_prefix access-om3.mom6.r.1900-01-01-00000 --nprocs 4